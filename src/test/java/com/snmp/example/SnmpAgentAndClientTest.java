...
import com.snmp.example.Agent;
import com.snmp.example.MOScalarFactory;
import com.snmp.example.MOTableBuilder;
import com.snmp.example.SimpleSnmpClient;
...
public class SnmpAgentAndClientTest {
	...
	static final OID interfacesTable2 = new OID(".1.3.6.1.2.1.2.2.1.2");
...
//    	assertEquals("sagar", client.getAsString(interfacesTable2));
    }
